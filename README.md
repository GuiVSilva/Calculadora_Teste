 ...
 * Versão: 2.0
 *
 * Adicionada a classe `CalculadoraJUNIT` para realizar operações matemáticas e a classe `CalculadoraJUNITTest` com cenários de teste usando JUnit5.
 *
 * ## Classe `CalculadoraJUNIT`
 *
 * ### Métodos
 *
